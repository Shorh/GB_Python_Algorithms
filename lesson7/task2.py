# 2. Отсортируйте по возрастанию методом слияния одномерный вещественный
# массив, заданный случайными числами на # промежутке [0; 50). Выведите на
# экран исходный и отсортированный массивы.
