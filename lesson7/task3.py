# 3. Массив размером 2m + 1, где m – натуральное число, заполнен случайным
# образом. Найдите в массиве медиану.
# Медианой называется элемент ряда, делящий его на две равные части: в одной
# находятся элементы, которые не меньше медианы, в другой – не больше медианы.
#
